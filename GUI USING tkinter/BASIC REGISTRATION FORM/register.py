...
class Register:
    ...
    def sp_insert(self, cur):
        ...
        args = [self.name.get(), self.phone.get(), self.gender.get(), self.email.get()]
        #cur.execute("call sp_insert(%s,%s,%s,%s)", (self.name.get(), self.phone.get(), self.gender.get(), self.email.get()))
        cur.callproc("sp_insert", args)

    
    def sp_view_data(self, cur):

        #cur.callproc("sp_display")
    ...
    def sp_delete_row(self, cur):
        ...
        args = [self.id.get()]
        #cur.execute(f"call sp_delete_row({self.id.get()})")
        cur.callproc("sp_delete_row", args)
